...
public class AdminController {
    ...
    public String editOrder(/*@ModelAttribute("orders") @Valid Order orders, BindingResult bindingResult,*/ @Valid Order orders, BindingResult bindingResult, @PathVariable("id") int id, Model model, String status){
        model.addAttribute("", personService.getPersonId(id));
        orders = orderService.getOrderId(id);
      ...
      //  float price = orders.getPrice();
       // LocalDateTime dateTime = orders.getDateTime();
       // model.addAttribute("status", orders.getStatus());
        ...
        System.out.println(orders.getCount());
        System.out.println(orders.getPrice());
        System.out.println(orders.getDateTime());
        System.out.println(orders.getStatus());
        orderRepository.save(orders);

       // orderService.updateOrder(id, number, product, person, count, price, dateTime, status, orders);
        return "redirect:/detailInfoOrders";
    }
    ...
    public String editPerson(@ModelAttribute("person") @Valid Person person, BindingResult bindingResult, @PathVariable("id") int id, Model model){
        ...
        return "redirect:/detailInfoPerson";
    }
